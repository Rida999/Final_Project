    ...
    <div class="page">
                ...
                <div class="rd-navbar-right rd-navbar-nav-wrap">
                  ...
                  <div class="rd-navbar-main">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="restaurants">Restaurants</a>
                      </li>
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="about">About us</a>
                      </li>
                  ...
                  <div class="rd-navbar-project-content rd-navbar-content">
                    <div>
                      <div class="row gutters-20" data-lightgallery="group">
                        <div class="col-6">
                          <!-- Thumbnail Creative-->
                          <article class="thumbnail thumbnail-creative"><a href={{url('frontend/images/project-1-1200x800-original.jpg')}} data-lightgallery="item">
                              <div class="thumbnail-creative-figure"><img src={{url('frontend/images/project-1-195x164.jpg')}} alt="" width="195" height="164"/>
                              </div>
                        ...
                        <div class="col-6">
                          ...
                          <article class="thumbnail thumbnail-creative"><a href="images/project-2-1200x800-original.jpg" data-lightgallery="item">
                              <div class="thumbnail-creative-figure"><img src={{url('frontend/images/project-2-195x164.jpg')}} alt="" width="195" height="164"/>
                              </div>
                              <div class="thumbnail-creative-caption"><span class="icon thumbnail-creative-icon linearicons-magnifier"></span></div></a></article>
                        </div>
                        <div class="col-6">
                          ...
                          <article class="thumbnail thumbnail-creative"><a href="images/project-3-1200x800-original.jpg" data-lightgallery="item">
                              <div class="thumbnail-creative-figure"><img src={{url('frontend/images/project-3-195x164.jpg')}} alt="" width="195" height="164"/>
                              </div>
                              <div class="thumbnail-creative-caption"><span class="icon thumbnail-creative-icon linearicons-magnifier"></span></div></a></article>
                        </div>
                        <div class="col-6">
                          ...
                          <article class="thumbnail thumbnail-creative"><a href="images/project-4-1200x800-original.jpg" data-lightgallery="item">
                              <div class="thumbnail-creative-figure"><img src={{url('frontend/images/project-4-195x164.jpg')}} alt="" width="195" height="164"/>
                              </div>
                              <div class="thumbnail-creative-caption"><span class="icon thumbnail-creative-icon linearicons-magnifier"></span></div></a></article>
                        </div>
                        <div class="col-6">
                          ...
                          <article class="thumbnail thumbnail-creative"><a href="images/project-5-1200x800-original.jpg" data-lightgallery="item">
                              <div class="thumbnail-creative-figure"><img src={{url('frontend/images/project-5-195x164.jpg')}} alt="" width="195" height="164"/>
                              </div>
                              <div class="thumbnail-creative-caption"><span class="icon thumbnail-creative-icon linearicons-magnifier"></span></div></a></article>
                        </div>
                        <div class="col-6">
                          ...
                          <article class="thumbnail thumbnail-creative"><a href="images/project-6-1200x800-original.jpg" data-lightgallery="item">
                              <div class="thumbnail-creative-figure"><img src={{url('frontend/images/project-6-195x164.jpg')}} alt="" width="195" height="164"/>
                              </div>
                              <div class="thumbnail-creative-caption"><span class="icon thumbnail-creative-icon linearicons-magnifier"></span></div></a></article>
                        </div>
                      </div>
                      <div class="rd-navbar-login">
                        <a href="login" class="rd-navbar-login-btn">Login</a>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section class="bg-gray-7">
        <div class="breadcrumbs-custom box-transform-wrap context-dark">
          ...
          <div class="box-transform" style="background-image: url(frontend/images/about.png);"></div>
        </div>
        <div class="container">
            ...
            <div class="col-lg-8 col-xl-9">
              ...
              <div class="tab-content tab-content-1">
                <div class="tab-pane fade show active" id="tabs-4-1">
                  ...
                  <p>Welcome to RCLN, your one-stop platform to discover the best restaurants and conveniently place orders from the comfort of your home! We partner with a wide variety of local eateries, offering everything from casual bites to fine dining, ensuring there’s something for everyone.</p>
                    
                  <p>Our mission is simple: to make ordering food easy, quick, and enjoyable. Whether you're craving a delicious pizza, sushi, or a full-course meal, we’ve got you covered. With just a few clicks, you can browse menus, read reviews, and place an order — all in one place.</p>
                    
                  <p>We’re committed to providing you with a seamless experience and bringing tasty meals straight to your door. Join us today, and let us take care of your cravings!</p>
                  <img src={{url('frontend/images/aboutus.png')}} alt="" width="835" height="418"/>
                </div>
                <div class="tab-pane fade" id="tabs-4-2">
                  <h4>Offering the Best Restaurants</h4>
                  <p>At RCLN, we bring the best of Los Angeles' culinary scene right to your fingertips. Whether you're craving a gourmet burger, authentic sushi, fresh Italian pasta, or a cozy café experience, our platform makes it easy to explore a wide variety of local restaurants.</p>

                  <p> partner with top restaurants across the city to provide you with an exciting range of dining options. Browse menus, read reviews, and place your order all in one place. From quick bites to fine dining, we’ve got something for every taste and occasion. No matter what you're in the mood for, RCLN ensures a seamless, satisfying experience for every meal.</p>
                  <img src={{url('frontend/images/mission.png')}} alt="" width="835" height="418"/>
                </div>
                <div class="tab-pane fade" id="tabs-4-3">
                  <h4>Delivering Exceptional Customer Service</h4>
                  <p>At RCLN, providing outstanding customer service is at the heart of everything we do. We strive to ensure that every interaction with our platform is smooth, efficient, and enjoyable. Whether you're browsing through our diverse restaurant options, placing an order, or seeking support, our dedicated team is here to assist you every step of the way.</p>

                  <p>Our commitment to excellence means we listen to your needs and work hard to exceed your expectations. With our user-friendly app and attentive customer support, we aim to make your dining experience as seamless as possible. We understand that when it comes to food, convenience, and service, every detail matters. That's why we go above and beyond to deliver not just great meals but a great experience from start to finish.</p>
                    
                  <p>No matter what you're looking for—whether it's a quick bite or a full-course meal—our goal is to make your experience effortless and enjoyable, every time.</p>
                  <img src={{url('frontend/images/goal.png')}} alt="" width="835" height="418"/>
                </div>
                <div class="tab-pane fade" id="tabs-4-4">
                  <h4>Integrity & Dedication</h4>
                  <p>At RCLN, integrity and dedication are the pillars of our service. We are fully committed to providing a trustworthy, transparent, and reliable platform for all your dining needs. Every restaurant listed, every order placed, and every interaction with our team is built on a foundation of honesty and responsibility.</p>

                  <p>We pride ourselves on our dedication to customer satisfaction. From the moment you browse our diverse selection of restaurants to the time your meal arrives at your door, we ensure that quality and consistency are never compromised. We are dedicated to continuously improving your experience, offering seamless service, and ensuring your satisfaction with every order.</p>
                    
                  <p>Our team’s commitment to integrity drives us to uphold the highest standards in everything we do, so you can trust us to provide not just great food, but an exceptional, reliable service.</p>
                  <img src={{url('frontend/images/value.png')}} alt="" width="835" height="418"/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row row-60 justify-content-center justify-content-xxl-between">
              ...
              <div class="tabs-custom" id="tabs-5">
                <div class="tab-content tab-content-1">
                  <div class="tab-pane fade" id="tabs-5-1">
                    <h5 class="font-weight-normal text-transform-none text-spacing-75">The Launch of RCLN Idea - The Start Of Our Work</h5>
                    <p>In September, we embark on the exciting journey of gathering fresh ideas and shaping the vision for our restaurant's website. It's the time when we lay the groundwork, carefully curating every detail—from the user experience to the design elements—ensuring that every aspect reflects the essence of our brand.</p>
                  </div>
                  <div class="tab-pane fade" id="tabs-5-2">
                    <h5 class="font-weight-normal text-transform-none text-spacing-75">Learning Laravel and Building the Database</h5>
                    <p>In October, we started learning Laravel to build the foundation of our app. We focused on designing and structuring the database, ensuring that it would be efficient, scalable, and easy to work with as we move forward with development.</p>
                  </div>
                  <div class="tab-pane fade" id="tabs-5-3">
                    <h5 class="font-weight-normal text-transform-none text-spacing-75">Building the Back-End: CRUD Operations, Controllers, and Models</h5>
                    <p>In November, we built out the back-end of the application. This included creating all the necessary CRUD operations, setting up the controllers, and defining the models. The focus was on ensuring a smooth and functional back-end that would support the front-end features and user interactions.</p>
                  </div>
                  <div class="tab-pane fade show active" id="tabs-5-4">
                    <h5 class="font-weight-normal text-transform-none text-spacing-75">Developing the Front-End for Users and Admin Pages</h5>
                    <p>In December, we shifted our focus to developing the front-end for both the user interface and the admin pages. The goal was to create a clean, responsive, and intuitive design that allows users to easily interact with the app, while providing administrators with the tools needed to manage and monitor the platform efficiently.</p>
                  </div>
                </div>
            ...
            <div class="col-md-9 col-lg-6 position-static index-1">
              <div class="bg-image-right-1 bg-image-right-lg">
                <img src={{url('frontend/images/our_history-1110x710.jpg')}} alt="" width="1110" height="710"/>
                ...
                <div class="box-transform" style="background-image: url(frontend/images/history.png);"></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="offset-left-xl-70">
                ...
                <div class="slick-quote">
                  ...
                  <div class="slick-slider child-carousel" id="child-carousel-5" data-arrows="true" data-for=".carousel-parent" data-items="4" data-sm-items="4" data-md-items="4" data-lg-items="4" data-xl-items="4" data-slide-to-scroll="1">
                    <div class="item"><img class="img-circle" src={{url('frontend/images/team-5-83x83.jpg')}} alt="" width="83" height="83"/>
                    </div>
                    <div class="item"><img class="img-circle" src={{url('frontend/images/team-6-83x83.jpg')}} alt="" width="83" height="83"/>
                    </div>
                    <div class="item"><img class="img-circle" src={{url('frontend/images/team-7-83x83.jpg')}} alt="" width="83" height="83"/>
                    </div>
                    <div class="item"><img class="img-circle" src={{url('frontend/images/team-8-83x83.jpg')}} alt="" width="83" height="83"/>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-6 col-xl-7"><img src={{url('frontend/images/wp-say-669x447.jpg')}} alt="" width="669" height="447"/>
            </div>
          </div>
        </div>
      </section>
