                ...
                <div class="rd-navbar-right rd-navbar-nav-wrap">
                  ...
                  <div class="rd-navbar-main">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="{{url('restaurants')}}">Restaurants</a></li>
                      ...
                      <div class="row gutters-20" data-lightgallery="group">
                        ...
                        <div class="col-6">
                          ...
                          <article class="thumbnail thumbnail-creative"><a href="{{url('frontend/images/project-4-1200x800-original.jpg')}}" data-lightgallery="item">
                              <div class="thumbnail-creative-figure"><img src="{{url('frontend/images/project-4-195x164.jpg')}}" alt="" width="195" height="164"/></div>
                              <div class="thumbnail-creative-caption"><span class="icon thumbnail-creative-icon linearicons-magnifier"></span></div></a></article>
                        </div>
                        <div class="col-6">
                          <!-- Thumbnail Creative-->
              ...
              <div class="container">
                <div class="row">
                  <div class="col-sm-8 col-lg-7 offset-lg-1 offset-xxl-0">
                    ...
                    <div class="button-wrap oh"><a class="button button-lg button-primary button-winona button-shadow-2" href="#" data-caption-animate="slideInUp" data-caption-delay="0">View our Special Offers</a></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            @foreach($reviews as $review)
              ...
              <article class="quote-tara">
                <div class="quote-tara-caption">
                  ...
                  <div class="quote-tara-figure"><img src="{{ url('frontend/images/people.png') }}" alt="" width="115" height="115"/>
                  </div>
                </div>
