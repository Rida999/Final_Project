    ...
    <div class="page">
            ...
            <div class="rd-navbar-inner-outer">
              <div class="rd-navbar-inner">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="{{url('home')}}"><img class="brand-logo-dark" src="{{url('frontend/images/logo1.png')}}" alt="" width="198" height="66"/></a></div>
                </div>
                <div class="rd-navbar-right rd-navbar-nav-wrap">
                  ...
                  <div class="rd-navbar-main">
                    ...
                    <ul class="rd-navbar-nav">
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="{{url('home')}}">Home</a></li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="{{url('restaurants')}}">Restaurants</a></li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="{{url('about')}}">About us</a></li>
                  ...
                  <div class="rd-navbar-project-content rd-navbar-content">
                    <div>
                      <div class="row gutters-20" data-lightgallery="group">
                        ...
                        <div class="col-6">
                          <!-- Thumbnail Creative-->
                          <article class="thumbnail thumbnail-creative"><a href="{{url('frontend/images/project-2-1200x800-original.jpg')}}" data-lightgallery="item">
                        ...
                        <div class="col-6">
                          <!-- Thumbnail Creative-->
                          <article class="thumbnail thumbnail-creative"><a href="{{url('frontend/images/project-3-1200x800-original.jpg')}}" data-lightgallery="item">
                        ...
                        <div class="col-6">
                          <!-- Thumbnail Creative-->
                          <article class="thumbnail thumbnail-creative"><a href="{{url('frontend/images/project-4-1200x800-original.jpg')}}" data-lightgallery="item">
                        ...
                        <div class="col-6">
                          <!-- Thumbnail Creative-->
                          <article class="thumbnail thumbnail-creative"><a href="{{url('frontend/images/project-5-1200x800-original.jpg')}}" data-lightgallery="item">
                        ...
                        <div class="col-6">
                          <!-- Thumbnail Creative-->
                          <article class="thumbnail thumbnail-creative"><a href="{{url('frontend/images/project-6-1200x800-original.jpg')}}" data-lightgallery="item">
      ...
      <section class="section swiper-container swiper-slider swiper-slider-2 swiper-slider-3" data-loop="true" data-autoplay="5000" data-simulate-touch="false" data-slide-effect="fade">
        <div class="swiper-wrapper text-sm-left">
          <div class="swiper-slide context-dark" data-slide-bg="{{url('frontend/images/poster2.png')}}">
          ...
          <div class="swiper-slide context-dark" data-slide-bg="{{url('frontend/images/poster1.png')}}">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
          ...
          <div class="swiper-slide context-dark" data-slide-bg="{{url('frontend/images/poster3.png')}}">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-sm-8 col-lg-7 offset-lg-1 offset-xxl-0">
                    <h1 class="oh swiper-title"><span class="d-inline-block" data-caption-animate="slideInDown" data-caption-delay="0">The best burger</span></h1>
                    <p class="big swiper-text" data-caption-animate="fadeInRight" data-caption-delay="300">Savor the succulence of the meat for an unmatched burst of flavor.</p>
                    <div class="button-wrap oh"><a class="button button-lg button-primary button-winona button-shadow-2" href="#" data-caption-animate="slideInUp" data-caption-delay="0">View our menu</a></div>
                  </div>
                </div>
              </div>
      ...
      <!-- Section CTA-->
      <section class="primary-overlay section parallax-container" data-parallax-img="{{url('frontend/images/pizza.png')}}">
        ...
        <div class="container-fluid container-inset-0 isotope-wrap">
          <div class="row row-10 gutters-10 isotope" data-isotope-layout="masonry" data-isotope-group="gallery" data-lightgallery="group">
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              <!-- Thumbnail Mary-->
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure" href="{{url('frontend/images/gallery-1-1200x800-original.jpg')}}" data-lightgallery="item"><img src="{{url('frontend/images/gallery-1-310x585.jpg')}}" alt="" width="310" height="585"/></a>
            ...
            <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
              <!-- Thumbnail Mary-->
              <article class="thumbnail thumbnail-mary thumbnail-mary-big wow slideInRight"><a class="thumbnail-mary-figure" href="{{url('frontend/images/gallery-2-1200x800-original.jpg')}}" data-lightgallery="item"><img src="{{url('frontend/images/gallery-2-631x587.jpg')}}" alt="" width="631" height="587"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
            ...
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              <!-- Thumbnail Mary-->
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInDown"><a class="thumbnail-mary-figure" href="{{url('frontend/images/gallery-3-1200x800-original.jpg')}}" data-lightgallery="item"><img src="{{url('frontend/images/gallery-3-311x289.jpg')}}" alt="" width="311" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
            ...
            <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
              <!-- Thumbnail Mary-->
              <article class="thumbnail thumbnail-mary wow slideInUp"><a class="thumbnail-mary-figure" href="{{url('frontend/images/gallery-4-1200x800-original.jpg')}}" data-lightgallery="item"><img src="{{url('frontend/images/gallery-4-631x289.jpg')}}" alt="" width="631" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
            ...
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              <!-- Thumbnail Mary-->
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInUp"><a class="thumbnail-mary-figure" href="{{url('frontend/images/gallery-5-1200x800-original.jpg')}}" data-lightgallery="item"><img src="{{url('frontend/images/gallery-5-311x289.jpg')}}" alt="" width="311" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
            ...
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              <!-- Thumbnail Mary-->
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInRight"><a class="thumbnail-mary-figure" href="{{url('frontend/images/gallery-6-1200x800-original.jpg')}}" data-lightgallery="item"><img src="{{url('frontend/images/gallery-6-311x289.jpg')}}" alt="" width="311" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
            ...
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              <!-- Thumbnail Mary-->
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure" href="{{url('frontend/images/gallery-7-1200x800-original.jpg')}}" data-lightgallery="item"><img src="{{url('frontend/images/gallery-7-311x289.jpg')}}" alt="" width="311" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
            ...
            <div class="row row-30 align-items-center">
              <div class="col-sm-6 col-md-7 col-lg-4 col-xl-4">
                <div class="row row-30 align-items-center text-lg-center">
                  <div class="col-md-7 col-xl-6"><a class="brand" href="{{url('home')}}"><img src="{{ url('frontend/images/logo22.png') }}" alt="" width="198" height="66"/></a></div>
              ...
              <div class="col-sm-6 col-md-12 col-lg-8 col-xl-8 oh-desktop">
                <div class="group-xmd group-sm-justify">
                  ...
                  <div class="wow slideInRight">
                    <ul class="list-inline footer-social-list footer-social-list-2 ```html
                    footer-social-list-3">
                      <li><a class="icon mdi mdi-facebook" href="#"></a></li>
                      <li><a class="icon mdi mdi-twitter" href="#"></a></li>
                      <li><a class="icon mdi mdi-instagram" href="#"></a></li>
                      <li><a class="icon mdi mdi-google-plus" href="#"></a></li>
